 // helper: red numbers on a standard wheel - DEFINED FIRST
    ...
    function animateSpin(timestamp) {
        ...
        if (lifetime > 4.67) {
            animationId = null;
            displayWheelResult();
            // Re-enable betting after spin completes
            isSpinning = false;
            enableBetting();
            return;
        }
    ...
    let activeBets = []; // array of { amount: number, choice: string, displayLabel: string, element: HTMLElement }
